      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className={`px-3 py-1 rounded-md ${viewMode === 'day' ? 'bg-blue-600 text-white' : 'bg-gray-100'
              }`}
          >
            Day View
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-md ${viewMode === 'room' ? 'bg-blue-600 text-white' : 'bg-gray-100'
              }`}
          >
            Room View
          </button>
          ...
          <div className="flex space-x-2 mb-4">
            {days.map(day => (
              <button
                ...
                className={`px-3 py-1 rounded-md ${day === selectedDay ? 'bg-blue-600 text-white' : 'bg-gray-100'
                  }`}
              >
                {day}
              </button>
