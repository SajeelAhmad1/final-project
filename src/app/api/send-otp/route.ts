...
export async function POST(req: NextRequest) {
    ...
    try {
      ...
      await transporter.sendMail({
        from: '"Academic Management System" <sajeelashiq1@gmail.com>',
        to: email,
        subject: "Your OTP Code - Academic Management System",
        html: `
        <div style="font-family: 'Helvetica Neue', Arial, sans-serif; background-color: #ffffff; padding: 20px; text-align: center; border-radius: 10px;">
            <div style="background: linear-gradient(to bottom, #579FE1, #2290F3); padding: 15px; border-radius: 10px;">
              <h1 style="margin: 0; font-size: 28px; color: #ffffff;">Academic Management System</h1>
            </div>
            ...
            <div style="margin-top: 30px; padding: 10px; border-top: 1px solid #2290F3;">
              <p style="font-size: 12px; color: #777777;">© 2025 Academic Management System. All rights reserved.</p>
            </div>
          </div>
        `,
      });
