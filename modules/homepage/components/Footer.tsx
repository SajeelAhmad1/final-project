        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0 md:w-1/3">
            <div className="flex items-center mb-4">
              ...
              <span className="text-white text-2xl ml-2 font-light">SYSTEM</span>
            </div>
            <p className="text-white text-sm">
              Empowering Schools And Students With Seamless, Integrated Tools For Better Education.
            </p>
            <div className="flex mt-6 space-x-4">
              <a href="#" className="bg-white bg-opacity-20 rounded-full p-2">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white text-sm hover:underline">Our Story</a></li>
              ...
              <li><a href="#" className="text-white text-sm hover:underline">Contact</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-white py-4 px-6 border-t border-gray-200">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-6 mb-4 md:mb-0">
            ...
            <a href="#" className="text-gray-600 text-sm">Cookies Policy</a>
            <a href="#" className="text-gray-600 text-sm">Terms & Conditions</a>
          </div>
          <div>
            <p className="text-gray-600 text-sm">© Copyright 2025, Academic System. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </footer>
