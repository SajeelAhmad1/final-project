...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { title: 'Sessions', icon: <BookOpen size={20} />, path: '/admin/sessions' },
    { title: 'Classes', icon: <Clock size={20} />, path: '/admin/classes' },
    { title: 'Rooms', icon: <Building size={20} />, path: '/admin/rooms' },
    { title: 'Time Table', icon: <Building size={20} />, path: '/admin/timetable' },
    { title: 'Enrollments', icon: <Building size={20} />, path: '/admin/enrollments' },
